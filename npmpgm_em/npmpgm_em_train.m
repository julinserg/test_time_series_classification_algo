function [Probability, cellNetKox] = npmpgm_em_train(dataTrainRaw,dataTrainForClass, row_map, col_map, epohs_map, val_dirichlet)
...
for i=1:size(dataTrainForClass,1)
  ...
  GMModel = fitgmdist(F',row_map * col_map,'Options',options);
  net = GMModel.mu;
